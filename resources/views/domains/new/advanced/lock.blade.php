            ...
            <div class="card-block">
                ...
                <div v-if="data.advanced_lock_status == false" v-cloak>
                    ...
                    <div class="row form-group">
                        <div class="col-md-3">
                            <select class="form-control" v-model="new_account">
                                ...
                                @foreach(auth()->user()->teams->where('id', '!=', auth()->user()->currentTeam->id) as $account)
                    ...
                    <div class="row form-group">
                        ...
                        <form action="{{ route('domains.advanced.confirm_delete', $domain) }}" method="GET" id="delete_form">
                        </form>
