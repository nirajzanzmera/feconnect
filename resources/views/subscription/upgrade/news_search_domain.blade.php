        ...
        <div class="col-md-8 col-md-offset-2" style="padding-top:70px;">
            ...
            <div class="card">
                ...
                <div class="card-block">
                    <p>
                        Sign-up for our exclusive email marketing newsletter and we’ll give you a domain name 
                        and website 30 days for free! You’ll also get access to all of the Dataczar features 
                        FREE for 30 days, and then it’s just $9.95 a month to the same card you used today. 
                    ...
                    <div class="row form-group">
                        ...
                        <input name="search" type="text" class="form-control" value="[username]">
                    </div>
                </div>
                <div class="card-block" style="text-align: center">
                    <div class="row form-group">
