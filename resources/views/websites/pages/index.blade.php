            ...
            <div class="card-block card-block-light">
                ...
                <div class="card">
                       ...
                       <div class="row">
                           ...
                           <div class="col-md-6">
                               <div class="pull-right" style="display: flex; align-items: center; ">
                                    <div class="btn-group">
                                        <a href="{{ route('websites.pages.create', ['website'=>$website, 'menu'=>$menu]) }}"
                                        ...
                                        <div class="btn-group">
                                            <div class="dropdown show">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
                                                    ...
                                                    <a href="{{ route('websites.templates.index', ['website'=>$website, 'menu'=>$menu]) }}"
                                                        class="dropdown-item" title="Create New Page to {{ $menu->name }} menu from Template">
                                                        <i class="fa fa-plus"></i>
                                                        Create Page from Template
                                                    </a>
                                                    <a href="{{ route('websites.pages.create2', ['website'=>$website, 'menu'=>$menu, 'type'=>'link']) }}"
                                                        data-menu_id="{{ $menu->id }}" class="show-link dropdown-item"
                                                        title="Create new external link to {{ $menu->name }} menu">
                                                        <i class="fa fa-plus"></i>
                                                        Create Link in Menu
                                                    </a>
                                                    <a href="{{ route('websites.posts.index', ['website'=>$website]) }}"
                                                        class="dropdown-item" title="Create New Page to {{ $menu->name }} menu">
                    ...
                    <ul id="sortable{{ $menu->id }}" class="list-group sortable" data-menu_id="{{ $menu->id }}"
                        data-url="{{ route('websites.menus.sort', ['website'=>$website, 'menu'=>$menu]) }}">
                        @foreach($menu->menu_pages as $page)
                        @include('websites.pages._page')
                        @endforeach
                    </ul>
                </div><!-- end card -->
                ...
                <div class="card">
                           ...
                           <div class="col-md-6">
                               <div class="pull-right" style="display: flex; align-items: center; ">
                                   <div class="btn-group">
                                        ...
                                        <a href="{{ route('websites.pages.create', ['website'=>$website]) }}" 
                                    ...
                                    <div class="btn-group">
                                        <div class="dropdown show">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
                                                ...
                                                <a href="{{ route('websites.templates.index', ['website'=>$website]) }}"
                                                    class="dropdown-item" title="Create New Page to {{ $menu->name }} menu from Template">
                                                    <i class="fa fa-plus"></i>
                                                    Create Page from Template
                                                </a>
                    ...
                    <ul id="sortable0" class="list-group sortable" data-menu_id="0"
                        data-url="{{ route('websites.menus.detach', ['website'=>$website]) }}">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function cb(start, end) {
            window.location = '{{ route("websites.pages.index", $website) }}?sd=' + start.format('YYYY-MM-DD') + '&ed=' + end.format('YYYY-MM-DD');
        }
