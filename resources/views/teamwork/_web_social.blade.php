        ...
        data: {
            config: {
                website: {
                    ...
                    suggestion: '',
                    value: '{{ old('website' , (isset($website->social_links->website)) ? $website->social_links->website : NULL ) }}',
                },
                facebook: {
                    id: 'username',
                    invalid: false,
                    ...
                    suggestion: '',
                    value: '{{ old('facebook' , (isset($website->social_links->{'facebook'})) ? $website->social_links->{'facebook'} : NULL ) }}',
                },
                twitter: {
                    id: 'username',
                    invalid: false,
                    ...
                    suggestion: '',
                    value: '{{ old('twitter' , (isset($website->social_links->{'twitter'})) ? $website->social_links->{'twitter'} : NULL ) }}',
                },
                linkedin: {
                    id: 'example-profile',
                    invalid: false,
                    ...
                    suggestion: '',
                    value: '{{ old('linkedin' , (isset($website->social_links->{'linkedin'})) ? $website->social_links->{'linkedin'} : NULL ) }}',
                },
                instagram: {
                    id: 'username',
                    invalid: false,
                    ...
                    suggestion: '',
                    value: '{{ old('instagram' , (isset($website->social_links->{'instagram'})) ? $website->social_links->{'instagram'} : NULL ) }}',
                },
                youtube: {
                    id: 'example-channel',
                    invalid: false,
                    ...
                    suggestion: '',
                    value: '{{ old('youtube' , (isset($website->social_links->{'youtube'})) ? $website->social_links->{'youtube'} : NULL ) }}',
                },
                yelp: {
                    id: 'example-name',
                    invalid: false,
                    ...
                    suggestion: '',
                    value: '{{ old('yelp' , (isset($website->social_links->{'yelp'})) ? $website->social_links->{'yelp'} : NULL ) }}',
                },
            },
        },
        methods: {
