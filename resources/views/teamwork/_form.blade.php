<div class="tab">
    <div class="row form-group{{ $errors->has('name') ? ' has-error' : '' }}">
        <label class="col-md-2 form-control-label">Website Name</label>
        <div class="col-md-9">
            @if(Route::currentRouteName() === 'home' or Route::currentRouteName() === 'mobileapp.dashboard')
            <input type="text" class="form-control" name="name" dusk="modal_name" value="{{ (!empty($team->name) && $team->name !== auth()->user()->name)  ? $team->name : NULL }}">
            @else
    ...
    <div class="row form-group{{ $errors->has('address_2') ? ' has-error' : '' }}">
        <label class="col-md-2 form-control-label">Address 2</label>
        <div class="col-md-9">
    ...
    <div class="row form-group{{ ($errors->has('city') || $errors->has('state') || $errors->has('zip')) ? ' has-error' : '' }}">
        ...
        <label class="col-md-1 form-control-label">State</label>
        <div class="col-md-2">
        ...
        <label class="col-md-1 form-control-label">Zip</label>
        <div class="col-md-2">
...
@if(Route::currentRouteName() !== 'home' and Route::currentRouteName() !== 'mobileapp.dashboard')
...
@endif
@if(Route::currentRouteName() === 'home' or Route::currentRouteName() === 'mobileapp.dashboard')
<div class="tab" style="{{ (Route::currentRouteName() == 'home' or Route::currentRouteName() == 'mobileapp.dashboard') ? 'display:none' : ''}}">
    <div id="socialform">
...
@endif
@if(Route::currentRouteName() !== 'home' and Route::currentRouteName() !== 'mobileapp.dashboard'  && ( empty(session('currentTeam')) ) )
<hr>
