        ...
        <div class="card">
            <div class="card-header">
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr id="news_{{ $news->id }}">
                        <td>
                            <img src="{{ url('https://dataczar-public.s3.us-west-2.amazonaws.com/').$news->thumb }}" style="max-width:50px; padding-right:5px;">
                            {{ $news->name }}
                        </td>
                        <td>
                            {{--{{  !empty($news->feed) ? --}}
                        ...
                        <td>
                            <div class="btn-group ">
                                ...
                                <a href="{{ route('newsletters.preview', ['news'=>$news->id]) }}" class="btn btn-sm btn-primary loading" title="Preview">
                                {{--<a href="" class="btn btn-sm btn-primary loading" title="Preview">--}}
                                    <i class="fa fa-eye"></i>
                                </a>
                                 <div class="btn-group">
                                        <div class="dropdown show">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                ...
                                                <a href="{{ route('newsletters.preview', ['news'=>$news->id]) }}" class="dropdown-item" title="Preview">
                                                <i class="fa fa-eye"></i> Preview
                                                </a>
                                                <a href="{{ route('newsletters.edit', ['news'=>$news->id]) }}" class="dropdown-item" title="Edit">
                                                    <i class="fa fa-edit"></i> Edit
                                                </a>
                                                <a href="{{ route('newsletters.saveAs', ['news'=>$news->id]) }}" class="dropdown-item" title="Save As">
                                                    <i class="fa fa-save"></i> Save As
                                                </a>
                                                <a href="#" class="dropdown-item news-delete" data-id="{{ $news->id }}" data-url="{{ route('newsletters.destroy',['news'=>$news->id] )}}"><i class="fa fa-trash-o"></i> Delete...</a>
                                                {{--<a href="#" class="dropdown-item news-delete" data-id="{{ $news->id }}" data-url=""><i class="fa fa-trash-o"></i> Delete...</a>--}}
                                            </div>
                                        </div>
                                    </div>
