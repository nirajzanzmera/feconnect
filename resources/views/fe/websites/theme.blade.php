    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-block">
                <form action="{{ route('websites.theme', $website->id) }}" method="POST">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    <div class="row">
                        <div class="col-lg-12">
                                ...
                                <div class="col-md-10">
                                    @if(isset($templates))
                                        @foreach($templates as $template)
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 items" style="padding-block: 10px; ">
                                                <div class="tmp-thumb">
                                                    <div class="row flex-column align-items-center justify-content-center" >
                                                        <a class="btn btn-primary fancybox" style="background-color: white; border: none" href="{{$template->thumb}}"
                                                           data-caption="{{$template->name}}"
                                                        >

                                                        <div class="theme-img-container " style="background-image: url('{{ $template->thumb ?? '' }}'">
                                                        </div>
                                                        </a>
                                                        <h5 style="text-align:center; padding-top:10px;" class="tmp-title">{{ $template->name }}</h5>
                                                        @if(!(old('template_id', !empty($website->template_id) ? $website->template_id : NULL ) == $template->id)) 
                                                        <div class="btn-group">
                                                            <!--<a href="{{ route('websites.theme', ['website'=>$website->id, 'id'=>$template->id]) }}" class="btn btn-default">
