...
{{--                            @include('websites._template_btns')--}}
                            ...
                            <input hidden name="content" class="aceEditorValue" v-model="site_data.post.content">
...
<script>
    ...
    editor.getSession().on('change', function() {
        let app_vue = document.getElementById('app').__vue__;
        app_vue.site_data.post.content = editor.getSession().getValue();
    });
</script>
