    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-block">
                <form action="{{ route('websites.update', $website->id) }}" method="POST" id="website_form">
                    <div class="row">
                                ...
                                <fieldset class="form-group {{ $errors->has($field) ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input id="{{ $field }}" class='form-control colorpicker' name="{{ $field }}"
                                            value="{{ old($field, isset($website->settings->address->{$field}) ? $website->settings->address->{$field} : NULL ) }}" />
                                    </div>
                                    @if ($errors->has($field))
                                    <span class="help-block">
                                ...
                                <div class="row form-group{{ $errors->has($field) ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" dusk="{{ $field }}" name="{{ $field }}" 
                                            value="{{ old($field, isset($website->settings->social_links->{$field}) ? $website->settings->social_links->{$field} : NULL ) }}" 
                                        />
                                        @if ($errors->has($field))
                                        <span class="help-block">
                                            <strong>{{ $errors->first($field) }}</strong>
                                    ...
                                    <div class="form-check">
                                        <label class="form-check-label" for="use_public">
                                            <input class="form-check-input" type="checkbox" id="use_public" name="use_public"
                                                {{ (old('use_public', !empty($website->settings->use_public) ? $website->settings->use_public : NULL ) == 1 ) ? 'checked' : ''  }}>
                                ...
                                <div class="col-md-8">
                                    <div class="form-check">
                                        ...
                                        {{--  {{  $website->id }} == {{ $website->team->default_website_id  }}<br /> --}}
                                            @if(!empty($website->team->default_website_id) && ($website->id == $team->default_website_id))
