...
<div id="app" v-on:change="stuffChanged()">
    <div class="row">
        ...
        <div class="col-md-6 ">
            <div class="row  form-group">
                <div class="col-lg-12">
                    ...
                    <a href="#" id="extraoptions_moreoptionbutton" onclick="
                        getElementById('extraoptions_lessoptionbutton').classList.toggle('hide');
                        getElementById('extraoptions_moreoptionbutton').classList.toggle('hide');
                        getElementById('extraoptions_extratemplates').classList.toggle('hide');
                        getElementById('extraoptions_extrafields').classList.toggle('hide');

                    " class="btn btn-default btn-sm">
                        <i class="fa fa-plus"></i> more options
                    </a>
                    <a href="#" id="extraoptions_lessoptionbutton" onclick="
                        getElementById('extraoptions_lessoptionbutton').classList.toggle('hide');
                        getElementById('extraoptions_moreoptionbutton').classList.toggle('hide');
                        getElementById('extraoptions_extratemplates').classList.toggle('hide');
                        getElementById('extraoptions_extrafields').classList.toggle('hide');
            ...
            <div id="extraoptions_extrafields" class="row  hide">
                <div class="col-md-12">
                    <div class="row ">
                        <div class="col-lg-2">
        ...
        <div id="extraoptions_extratemplates" class="row hide">
            <div class="col-md-12">
...
<script>
    ...
    var WebsiteDataUrl = '{!! route('websites.data', ['website'=>$website->id, 'post'=>!empty($post) ? $post : '', 'template' =>
