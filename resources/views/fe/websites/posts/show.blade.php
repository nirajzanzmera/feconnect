        ...
        <div class="card card-default">
            ...
            <div class="card-block">
                <div class="embed-responsive embed-responsive-4by3">
                   {{--<iframe id="preview-iframe" name="preview-iframe" class="embed-responsive-item" style="border: 1px solid #ddd;" src="{{ route('websites.posts.preview', ['id'=>$website->id, 'post'=>$post->id]) }}"></iframe>--}}
                   <iframe id="preview-iframe" name="preview-iframe" class="embed-responsive-item"
                           style="border: 1px solid #ddd;" src="{{ $preview_link }}"></iframe>
                </div>
            </div>
