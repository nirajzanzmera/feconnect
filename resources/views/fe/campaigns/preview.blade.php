...
<div class="row">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="pull-right">
                            ...
                            <strong>TIME:</strong> {{ $campaign->send_time ?? '' }} {{ $team->send_timezone ?? '' }}<br />
                        </div>
    ...
    <div class="col-md-5">
        @if(!empty($campaign) && (!empty($external) && $external == false))
                ...
                <div class="btn-group">
                    <div class="dropdown show">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            ...
                            <a class="dropdown-item" href="{{ route('campaigns.saveAs', $id) }}"><i class="fa fa-envelope"></i> New Email</a>
                            <a class="dropdown-item" href="{{ route('templates.saveAs', $id) }}"><i class="fa fa-puzzle-piece"></i> New Template</a>
                        </div>
                    </div>
                </div>
...
$(document).ready(function(){
    ...
    $('#send_test_email').on('click', function(){
        ...
        $.ajax({
            ...
            url: '{{ route('campaigns.send_test', !empty($campaign)?$campaign->id ?? $id:NULL) }}',
            @else 
            url: '{{ route('campaigns.send_test_limit', !empty($campaign)?$campaign->id ?? $id:NULL) }}',
            @endif
            type: 'GET',
            data: data,
