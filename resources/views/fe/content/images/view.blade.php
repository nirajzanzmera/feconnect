            ...
            <div class="card-block card-block-light">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        href="{{$file}}"
                        class="fancybox"
                        data-caption=" {{basename($file)}}"
                        >
                            <img id="image" src="{{$file}}" class="rounded img-thumbnail img-fluid">
                        </a>
                    </div>
                    <div class="col-md-6">
                        <div id="properties">
                            ...
                            <div class="d-flex">
                                ...
                                <span id="format" class="ml-2"></span>
                            </div>
                        </div>
                        {{--
                        ...
                        <div class="btn-group pull-right">
                            ...
                            <a class="btn btn-primary fancybox" href="{{$file}}"
                                data-caption="{{basename($file)}}"
                                >
                            ...
                            <div class="btn-group">
                                <div class="dropdown show">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right"
                                        ...
                                        <a href="{{route('images.edit', ['file' => $file])}}" class="dropdown-item">
                                            {{-- <i class="fa fa-btn fa-pen "></i> --}}
                                            <i class="fa fa-pencil"></i>
                                            Edit Image
                                        </a>
                                        <a class="dropdown-item fancybox" href="{{$file}}"
                                            data-caption="{{basename($file)}}"
                                            >
                                            <i class="fa fa-btn fa-eye  "></i>
                                        ...
                                        <a class="dropdown-item" target="_blank" href="https://www.zazzle.com/cr/buffet/at-238110888125061946?rf=238110888125061946&sr=250047085689669643&t__useQpc=false&ed=true&t__smart=false&continueUrl=https%3A%2F%2Fwww.zazzle.com%2Fstore%2Fdataczar&tc=&ic=&t_image1_iid={{urlencode($file)}}">
                                            <i class="fa fa-shopping-bag"></i> Buy Merchandise with this Image
                                        </a>
                                        <a class="dropdown-item" href="#"><i class="fa fa-trash"></i> Delete Image..</a>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        image.attr("src", $(image).attr("src")).load(function(){
            ...
            var fileExt = this.src.substr(this.src.lastIndexOf('.') + 1);
            $('#dimension').text(realWidth + 'x' + realHeight)
            $('#format').text(fileExt);
            $('#url').text(this.src);
